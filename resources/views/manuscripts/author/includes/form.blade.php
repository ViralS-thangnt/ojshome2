{!! Form::model($manuscript, ['route' => ['manuscript.update', $manuscript->id], 'files' => true, 'id' => 'form-manuscript'] ) !!}
...
@if($manuscript->status == IN_SCREENING_EDIT || $manuscript->status == IN_REVIEW_EDIT)
    ...
    $(document).ready(function(){
        $('.btn-primary').click(function(){
            if ($(this).hasClass('send')) {
                ...
                $('#form-manuscript').attr("action", "{{ isset($manuscript->id) ? url(Constant::$url['manuscript.withdrawn'] . '/' . $manuscript->id) : '' }}");
            }
